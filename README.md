...
1. Download curl by executing `pkg install curl`
2. Download script in **HOME** `curl -LO https://raw.githubusercontent.com/Hax4us/Nethunter-In-Termux/master/kalinethunter`
3. Give execution permission `chmod +x kalinethunter`
4. Run script `./kalinethunter`
