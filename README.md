# Nethunter-In-Termux
This is a script by which you can install Kali nethunter (Kali Linux) in your termux application without a rooted phone.
...
### Usage 
1. Use command `startkali` to start nethunter. Default user is __kali__ and the default password is also __kali__.
2. if you want to start nethunter as a root user then use the command `startkali -r`.
